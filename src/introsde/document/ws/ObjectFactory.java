...
public class ObjectFactory {
    ...
    private final static QName _User_QNAME = new QName("http://ws.document.introsde/", "user");
    private final static QName _LoginUser_QNAME = new QName("http://ws.document.introsde/", "loginUser");
    private final static QName _LoginUserResponse_QNAME = new QName("http://ws.document.introsde/", "loginUserResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.document.introsde/", name = "user")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.document.introsde/", name = "loginUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.document.introsde/", name = "loginUserResponse")
