...
public interface DB {
    ...
    @WebMethod
    @WebResult(name = "healthMeasure", targetNamespace = "http://soap.document.introsde/")
    @RequestWrapper(localName = "getRecentHealthMeasureByIdUser", targetNamespace = "http://soap.document.introsde/", className = "introsde.document.soap.GetRecentHealthMeasureByIdUser")
    @ResponseWrapper(localName = "getRecentHealthMeasureByIdUserResponse", targetNamespace = "http://soap.document.introsde/", className = "introsde.document.soap.GetRecentHealthMeasureByIdUserResponse")
    @Action(input = "http://soap.document.introsde/DB/getRecentHealthMeasureByIdUserRequest", output = "http://soap.document.introsde/DB/getRecentHealthMeasureByIdUserResponse")
    public HealthMeasure getRecentHealthMeasureByIdUser(
        @WebParam(name = "idUser", targetNamespace = "")
        Long idUser);
